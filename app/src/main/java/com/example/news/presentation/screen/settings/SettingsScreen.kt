...
fun SettingsScreen(
    ...
    val permissionLauncher = rememberLauncherForActivityResult(
        ...
        onResult = {
            viewModel.processCommand(SettingsCommand.SwitchNotifications(it))
        }
    )
    Scaffold(
                ...
                LazyColumn(
                    ...
                    item {
                        ...
                        SettingsCard(
                            ...
                            subtitle = stringResource(R.string.select_language_for_news_searching)
                        ) {
                            SettingsDropdown(
                    ...
                    item {
                        SettingsCard(
                            ...
                            subtitle = stringResource(R.string.hoe_often_to_update_news)
                        ) {
                            SettingsDropdown(
                    ...
                    item {
                        SettingsCard(
                            ...
                            subtitle = stringResource(R.string.show_notification_about_new_article)
                        ) {
                            Switch(
                                    ...
                                    if (enabled) {
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                                            ...
                                            viewModel.processCommand(
                                                SettingsCommand.SwitchNotifications(
                                                    enabled
                                                )
                                            )
                                        }
                    ...
                    item {
                        SettingsCard(
                            ...
                            subtitle = stringResource(R.string.save_mobile_network)
                        ) {
                            Switch(
